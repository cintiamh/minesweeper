...
(function() {
  ...
  */
  ...
  discover_neighbors = function(x, y) {
    var neighbor, neighbors, _i, _len, _ref, _ref1, _results;

    neighbors = get_neighbors(x, y);
    _results = [];
    for (_i = 0, _len = neighbors.length; _i < _len; _i++) {
      neighbor = neighbors[_i];
      if ((0 <= (_ref = neighbor.x) && _ref < levels[level].x) && (0 <= (_ref1 = neighbor.y) && _ref1 < levels[level].y)) {
