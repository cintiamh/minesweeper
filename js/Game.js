...
(function() {
  var REFRESH_RATE, TILE_SIZE, bombs, bombs_list, canvas, context, convert_num_to_time, drawBomb, drawFlag, drawWrong, draw_character, draw_down_button, draw_line, draw_square_back, draw_table, draw_up_button, exploded, find_item_in_list, fix_decimal, flags_list, flipped_list, generate_bombs, getMousePos, get_neighbors, height, level, levels, mouse_pos, num_colors, running, set_new_level, start_game, time, update_bombs, width, won;
